...
const StoreCountAnalysisContainer = forwardRef(
...
StoreCountAnalysisContainer.displayName = 'StoreCountAnalysisContainer'
export default StoreCountAnalysisContainer
