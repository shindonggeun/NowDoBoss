...
CREATE TABLE `chat_room` (
                             ...
                             `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정 날짜',
                             `chat_room_introduction` varchar(40) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '채팅방 소개',
                             `chat_room_name` varchar(20) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '채팅방 이름',
                             `category` varchar(20) COLLATE utf8mb3_bin NOT NULL COMMENT '카테고리',
                             PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `chat_message` (
                                ...
                                `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정 날짜',
                                `content` text COLLATE utf8mb3_bin NOT NULL COMMENT '채팅 내용',
                                `type` enum('ENTER','EXIT','TALK') COLLATE utf8mb3_bin DEFAULT NULL COMMENT '채팅 내용 종류',
                                PRIMARY KEY (`id`),
                                KEY `FK_chat_message_chat_room_id` (`chat_room_id`),
                                KEY `FK_chat_message_member_id` (`member_id`),
                                CONSTRAINT `FK_chat_message_chat_room_id` FOREIGN KEY (`chat_room_id`) REFERENCES `chat_room` (`id`),
                                CONSTRAINT `FK_chat_message_member_id` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `chat_room_member` (
                                    ...
                                    PRIMARY KEY (`id`),
                                    KEY `FK_chat_room_member_chat_room_id` (`chat_room_id`),
                                    KEY `FK_chat_room_member_member_id` (`member_id`),
                                    CONSTRAINT `FK_chat_room_member_chat_room_id` FOREIGN KEY (`chat_room_id`) REFERENCES `chat_room` (`id`),
                                    CONSTRAINT `FK_chat_room_member_member_id` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `community` (
                             ...
                             `member_id` int unsigned NOT NULL COMMENT '작성자 아이디',
                             `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정 날짜',
                             `content` text COLLATE utf8mb3_bin NOT NULL COMMENT '커뮤니티 글 내용',
                             `title` varchar(65) COLLATE utf8mb3_bin NOT NULL COMMENT '제목',
                             `category` varchar(20) COLLATE utf8mb3_bin NOT NULL COMMENT '카테고리',
                             PRIMARY KEY (`id`),
                             KEY `FK_community_member_id` (`member_id`),
...
CREATE TABLE `comment` (
                           ...
                           `member_id` int unsigned NOT NULL COMMENT '작성자 아이디',
                           `updated_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '수정 날짜',
                           `content` text COLLATE utf8mb3_bin NOT NULL COMMENT '댓글 내용',
                           PRIMARY KEY (`id`),
                           KEY `FK_comment_community_id` (`community_id`),
                           KEY `FK_comment_member_id` (`member_id`),
                           CONSTRAINT `FK_comment_community_id` FOREIGN KEY (`community_id`) REFERENCES `community` (`id`),
...
CREATE TABLE `image` (
                         ...
                         `url` varchar(255) COLLATE utf8mb3_bin NOT NULL COMMENT '이미지 url',
                         PRIMARY KEY (`id`),
                         KEY `FK_image_community_id` (`community_id`),
                         CONSTRAINT `FK_image_community_id` FOREIGN KEY (`community_id`) REFERENCES `community` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `service_type` (
                                ...
                                `service_code` varchar(255) COLLATE utf8mb3_bin NOT NULL COMMENT '업종 코드',
                                `service_code_name` varchar(255) COLLATE utf8mb3_bin NOT NULL COMMENT '업종 이름',
                                PRIMARY KEY (`id`)
...
CREATE TABLE `rent` (
                        ...
                        `district_code` varchar(5) COLLATE utf8mb3_bin NOT NULL COMMENT '자치구 코드',
                        `district_code_name` varchar(10) COLLATE utf8mb3_bin NOT NULL COMMENT '자치구 코드 명',
                        PRIMARY KEY (`id`)
...
CREATE TABLE `franchisee` (
                              ...
                              `brand_name` varchar(255) COLLATE utf8mb3_bin NOT NULL COMMENT '브랜드 이름',
                              PRIMARY KEY (`id`),
                              KEY `FK_franchisee_service_type_id` (`service_type_id`),
                              CONSTRAINT `FK_franchisee_service_type_id` FOREIGN KEY (`service_type_id`) REFERENCES `service_type` (`id`)
...
CREATE TABLE `sales_district` (
                                  ...
                                  `district_code` varchar(5) COLLATE utf8mb3_bin NOT NULL COMMENT '자치구 코드',
                                  `district_code_name` varchar(10) COLLATE utf8mb3_bin NOT NULL COMMENT '자치구 코드 명',
                                  `period_code` varchar(5) COLLATE utf8mb3_bin NOT NULL COMMENT '기준 년분기 코드',
                                  `service_code` varchar(8) COLLATE utf8mb3_bin NOT NULL COMMENT '서비스 업종 코드',
                                  `service_code_name` varchar(20) COLLATE utf8mb3_bin NOT NULL COMMENT '서비스 업종 코드 명',
                                  `service_type` enum('RESTAURANT','ACADEMY','LEISURE','SERVICE','RETAIL','HOUSEHOLDS') COLLATE utf8mb3_bin DEFAULT NULL COMMENT '서비스 업종 타입',
                                  PRIMARY KEY (`id`)
...
CREATE TABLE `change_district` (
                                   ...
                                   `change_indicator` varchar(5) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '상권 변화 지표',
                                   `change_indicator_name` varchar(15) COLLATE utf8mb3_bin DEFAULT NULL COMMENT '상권 변화 지표 명',
                                   `district_code` varchar(5) COLLATE utf8mb3_bin NOT NULL COMMENT '자치구 코드',
                                   `district_code_name` varchar(10) COLLATE utf8mb3_bin NOT NULL COMMENT '자치구 코드 명',
                                   `period_code` varchar(5) COLLATE utf8mb3_bin NOT NULL COMMENT '기준 년분기 코드',
                                   PRIMARY KEY (`id`)
...
CREATE TABLE `store_district` (
                                  ...
                                  `service_type` enum('RESTAURANT','ACADEMY','LEISURE','SERVICE','RETAIL','HOUSEHOLDS') COLLATE utf8mb3_bin DEFAULT NULL COMMENT '서비스 업종 타입',
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47453 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `store_administration` (
                                        ...
                                        `similar_store` int unsigned DEFAULT NULL COMMENT '유사 업종 점포 수',
                                        `total_store` int unsigned DEFAULT NULL COMMENT '점포 수',
                                        `administration_code` varchar(10) COLLATE utf8mb3_bin NOT NULL COMMENT '행정동 코드',
                                        `administration_code_name` varchar(20) COLLATE utf8mb3_bin NOT NULL COMMENT '행정동 코드 명',
                                        `period_code` varchar(5) COLLATE utf8mb3_bin NOT NULL COMMENT '기준 년분기 코드',
                                        `service_code` varchar(8) COLLATE utf8mb3_bin NOT NULL COMMENT '서비스 업종 코드',
                                        `service_code_name` varchar(20) COLLATE utf8mb3_bin NOT NULL COMMENT '서비스 업종 코드 명',
                                        `service_type` enum('RESTAURANT','ACADEMY','LEISURE','SERVICE','RETAIL','HOUSEHOLDS') COLLATE utf8mb3_bin DEFAULT NULL COMMENT '서비스 업종 타입',
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=105909 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `sales_administration` (
                                        ...
                                        `service_type` enum('RESTAURANT','ACADEMY','LEISURE','SERVICE','RETAIL','HOUSEHOLDS') COLLATE utf8mb3_bin DEFAULT NULL COMMENT '서비스 업종 타입',
                                        PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=50755 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `store_commercial` (
                                    ...
                                    `similar_store` int unsigned DEFAULT NULL COMMENT '유사 업종 점포 수',
                                    `total_store` int unsigned DEFAULT NULL COMMENT '점포 수',
                                    `commercial_classification_code` varchar(1) COLLATE utf8mb3_bin NOT NULL COMMENT '상권 구분 코드',
                                    `commercial_classification_code_name` varchar(4) COLLATE utf8mb3_bin NOT NULL COMMENT '상권 구분 코드 명',
                                    `commercial_code` varchar(8) COLLATE utf8mb3_bin NOT NULL COMMENT '상권 코드',
                                    `commercial_code_name` varchar(80) COLLATE utf8mb3_bin NOT NULL COMMENT '상권 코드 명',
                                    `period_code` varchar(5) COLLATE utf8mb3_bin NOT NULL COMMENT '기준 년분기 코드',
                                    `service_code` varchar(8) COLLATE utf8mb3_bin NOT NULL COMMENT '서비스 업종 코드',
                                    `service_code_name` varchar(20) COLLATE utf8mb3_bin NOT NULL COMMENT '서비스 업종 코드명',
                                    `service_type` enum('RESTAURANT','ACADEMY','LEISURE','SERVICE','RETAIL','HOUSEHOLDS') COLLATE utf8mb3_bin DEFAULT NULL COMMENT '서비스 업종 타입',
                                    PRIMARY KEY (`id`),
                                    KEY `idx_period_code` (`period_code`),
                                    KEY `idx_commercial_code` (`commercial_code`),
                                    KEY `idx_service_code` (`service_code`)
) ENGINE=InnoDB AUTO_INCREMENT=228400 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
...
CREATE TABLE `sales_commercial` (
                                    ...
                                    KEY `idx_commercial_code` (`commercial_code`),
                                    KEY `idx_service_code` (`service_code`)
) ENGINE=InnoDB AUTO_INCREMENT=113367 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_bin;
