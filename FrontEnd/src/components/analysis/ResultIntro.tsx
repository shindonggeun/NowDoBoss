      ...
      <r.RightWrap>
        ...
        <r.WarningDiv>
          ...
          <r.Text>
            ...
            제공하고자 하였으나, 시장 환경의 변화, 정책의 개정, 경제적 조건의
            변동 등 외부 요인에 의해 예고 없이 변경될 수 있습니다. 따라서 본
            레포트의 정보를 기반으로 한 의사결정은 사용자의 신중한 판단 하에
            이루어져야 하며, 이로 인해 발생할 수 있는 직접적, 간접적 손실에
            대해서는 당사가 책임지지 않음을 명시합니다. 또한, 본 레포트는
            일반적인 정보 제공을 목적으로 하며, 어떠한 경우에도 특정 사업의
            성공을 보장하거나, 투자 권유의 의도를 담고 있지 않습니다. 특히, 상권
            분석 및 사업 예측에는 다양한 변수가 작용할 수 있으므로, 본 레포트를
            사업 결정의 유일한 근거로 삼지 말고, 다양한 출처의 정보를 종합적으로
            검토하고 전문가의 조언을 구하는 것을 권장드립니다. 본 경고문을 통해,
            사용자께서는 본 레포트 정보를 활용함에 있어 발생할 수 있는 모든
            위험을 인지하고 이에 동의하는 것으로 간주합니다.
          </r.Text>
        </r.WarningDiv>
      </r.RightWrap>
    </r.Container>
